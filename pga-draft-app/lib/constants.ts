...
export const STATIC_ODDS: Record<string, [string, number][]> = {
  // Verified against official 2026 Masters field (91 players, April 9-12)
  // Sources: masters.com, Golf Monthly confirmed field, ESPN, PGA TOUR, search results
  // Removed: Niemann, Zalatoris, Si Woo Kim, Fowler, Hadwin, J.Day, T.Pendrith,
  //          Tom Kim, C.Davis, L.Glover, E.Cole, S.Theegala, D.McCarthy, A.Noren
  'masters': [
